interface EyeVideoProps {
  videoUrl: string;
}

const EyeVideo = ({ videoUrl }: EyeVideoProps) => {
  console.log(videoUrl);
  return (
    <div className='white-card col-span-10 col-start-2 row-span-4 flex flex-col items-start justify-start overflow-hidden'>
